...
delete oRequest["setGetRequestHeaders"];delete oRequest["applyRequestHeaders"];delete oRequest["finishRequest"];delete oRequest["status"];delete oRequest["cursor"];delete oRequest["challengeResponse"]};xajax.$=xajax.tools.$;xajax.getFormValues=xajax.tools.getFormValues;xajax.isLoaded=true;xjx={};xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;
