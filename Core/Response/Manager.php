...
namespace Xajax\Core\Response {
	...
	*/
	...
	final class Manager
	{
		...
		*/
		/**
		 * @var \Xajax\Core\Response\Response
		 */
		private $objResponse;
		/*
		...
		*/
		...
		{
			if ($mResponse instanceof \Xajax\Core\Response\Response)
			{
		...
		*/
		 ...
		 */
		public function getObjResponse(): ?\Xajax\Core\Response\Response
		{
